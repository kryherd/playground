...
#SBATCH --job-name=TopupKR			# Descriptive job name
...
./burc_wrapper_dtihw.sh topup --imain=/bind/data_out/b0_all --datain=/bind/scripts/acqparam.txt --config=b02b0.cnf --out=/bind/data_out/topup —iout=/bind/data_out/corrected_b0