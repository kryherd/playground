...
#SBATCH --time=01:00:00                         # Time limit hh:
#SBATCH --job-name=InteractiveFSL                       # Descriptive job name
...
export DIR_DATAIN=/scratch/birc_ro/ibrain_dwi                   #ro data
...
./burc_wrapper_dtihw.sh  /bin/bash